...
db.lessons.insertMany([
  ...
  { _id: "lesson-react-1", courseId: "course-react-patterns", title: "Introduction to Render Props", content: "# Render Props\n\nLearn the fundamentals of the render props pattern...", orderNumber: 1, videoUrl: "https://youtube.com/watch?v=react-1", durationMinutes: 10, isFree: true },
  { _id: "lesson-react-2", courseId: "course-react-patterns", title: "Custom Hooks Deep Dive", content: "# Custom Hooks\n\nBuild reusable logic with custom hooks...", orderNumber: 2, videoUrl: "https://youtube.com/watch?v=react-2", durationMinutes: 15, isFree: false },
  { _id: "lesson-react-3", courseId: "course-react-patterns", title: "Compound Components", content: "# Compound Components\n\nCreate flexible component APIs...", orderNumber: 3, videoUrl: "https://youtube.com/watch?v=react-3", durationMinutes: 13, isFree: false },

  // Python lessons
  { _id: "lesson-python-1", courseId: "course-python-basics", title: "Variables & Data Types", content: "# Python Basics\n\nLearn about variables...", orderNumber: 1, videoUrl: "https://youtube.com/watch?v=python-1", durationMinutes: 12, isFree: true },
  { _id: "lesson-python-2", courseId: "course-python-basics", title: "Control Flow", content: "# Control Flow\n\nIf statements, loops...", orderNumber: 2, videoUrl: "https://youtube.com/watch?v=python-2", durationMinutes: 14, isFree: false },
  { _id: "lesson-python-3", courseId: "course-python-basics", title: "Functions & Modules", content: "# Functions\n\nDefining and using functions...", orderNumber: 3, videoUrl: "https://youtube.com/watch?v=python-3", durationMinutes: 16, isFree: false },
  { _id: "lesson-python-4", courseId: "course-python-basics", title: "OOP in Python", content: "# OOP\n\nClasses, inheritance, polymorphism...", orderNumber: 4, videoUrl: "https://youtube.com/watch?v=python-4", durationMinutes: 20, isFree: false },

  // System Design lessons
  { _id: "lesson-sysdesign-1", courseId: "course-system-design", title: "Scalability Fundamentals", content: "# Scalability\n\nHorizontal vs vertical scaling...", orderNumber: 1, videoUrl: null, durationMinutes: 25, isFree: true },
  { _id: "lesson-sysdesign-2", courseId: "course-system-design", title: "Database Design", content: "# Database Design\n\nSQL vs NoSQL decisions...", orderNumber: 2, videoUrl: null, durationMinutes: 30, isFree: false },
  { _id: "lesson-sysdesign-3", courseId: "course-system-design", title: "Caching Strategies", content: "# Caching\n\nRedis, Memcached, CDN...", orderNumber: 3, videoUrl: null, durationMinutes: 22, isFree: false },
  { _id: "lesson-sysdesign-4", courseId: "course-system-design", title: "Load Balancing", content: "# Load Balancing\n\nRound robin, consistent hashing...", orderNumber: 4, videoUrl: null, durationMinutes: 18, isFree: false },
  { _id: "lesson-sysdesign-5", courseId: "course-system-design", title: "Message Queues", content: "# Message Queues\n\nRabbitMQ, Kafka patterns...", orderNumber: 5, videoUrl: null, durationMinutes: 20, isFree: false },

  // Docker & K8s lessons
  { _id: "lesson-dk-1", courseId: "course-docker-k8s", title: "Docker Basics", content: "# Docker\n\nContainerization fundamentals...", orderNumber: 1, videoUrl: null, durationMinutes: 15, isFree: true },
  { _id: "lesson-dk-2", courseId: "course-docker-k8s", title: "Multi-stage Builds", content: "# Multi-stage Builds\n\nOptimize your images...", orderNumber: 2, videoUrl: null, durationMinutes: 12, isFree: false },
  { _id: "lesson-dk-3", courseId: "course-docker-k8s", title: "Kubernetes Architecture", content: "# K8s\n\nPods, services, deployments...", orderNumber: 3, videoUrl: null, durationMinutes: 25, isFree: false },
  { _id: "lesson-dk-4", courseId: "course-docker-k8s", title: "Helm Charts", content: "# Helm\n\nPackaging K8s applications...", orderNumber: 4, videoUrl: null, durationMinutes: 18, isFree: false },

  // ML lessons
  { _id: "lesson-ml-1", courseId: "course-ml-fundamentals", title: "Supervised Learning", content: "# Supervised Learning\n\nRegression, classification...", orderNumber: 1, videoUrl: null, durationMinutes: 30, isFree: true },
  { _id: "lesson-ml-2", courseId: "course-ml-fundamentals", title: "Unsupervised Learning", content: "# Unsupervised Learning\n\nClustering, dimensionality reduction...", orderNumber: 2, videoUrl: null, durationMinutes: 25, isFree: false },
  { _id: "lesson-ml-3", courseId: "course-ml-fundamentals", title: "Neural Networks", content: "# Neural Networks\n\nPerceptrons, backpropagation...", orderNumber: 3, videoUrl: null, durationMinutes: 35, isFree: false },

  // TypeScript lessons
  { _id: "lesson-ts-1", courseId: "course-typescript-deep", title: "Advanced Generics", content: "# Generics\n\nConstraints, inference, conditional types...", orderNumber: 1, videoUrl: null, durationMinutes: 20, isFree: true },
  { _id: "lesson-ts-2", courseId: "course-typescript-deep", title: "Mapped Types", content: "# Mapped Types\n\nPartial, Required, Record...", orderNumber: 2, videoUrl: null, durationMinutes: 18, isFree: false },
  { _id: "lesson-ts-3", courseId: "course-typescript-deep", title: "Template Literal Types", content: "# Template Literals\n\nString manipulation at type level...", orderNumber: 3, videoUrl: null, durationMinutes: 15, isFree: false },
  { _id: "lesson-ts-4", courseId: "course-typescript-deep", title: "Type-safe Libraries", content: "# Type-safe Libraries\n\nBuilding robust APIs...", orderNumber: 4, videoUrl: null, durationMinutes: 22, isFree: false }
]);
...
db.lessons.createIndex({ courseId: 1, orderNumber: 1 });
