...
description: Writes new tests, runs existing suites, and fixes failures after code modifications. Ensures comprehensive test coverage and maintains suite integrity across unit, integration, and E2E tests.
color: cyan
---
