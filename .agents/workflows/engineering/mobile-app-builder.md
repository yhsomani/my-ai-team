...
description: Develops native and cross-platform mobile applications for iOS and Android. Specializes in smooth UI, native performance optimizations, platform integrations (biometrics, notifications), and App Store readiness.
color: green
