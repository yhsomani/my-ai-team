...
description: Analyzes test results, synthesizes data, identifies trends, and generates quality metrics reports. Specializes in turning raw test data into actionable insights to drive quality improvements.
color: yellow
