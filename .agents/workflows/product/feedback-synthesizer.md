...
description: Analyzes user feedback from multiple sources to identify patterns and prioritize feature development. Specializes in sentiment analysis and turning raw user input into actionable product insights.
color: orange
