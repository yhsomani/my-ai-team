...
description: Tracks A/B tests, feature experiments, and iterative improvements. Specializes in data-driven validation of product features within rapid development cycles.
color: blue
