---
name: ux-researcher
description: Conducts user research and behavioral analysis to bridge the gap between user needs and rapid development. Specializes in lean methodologies, journey mapping, and usability testing to inform actionable design decisions.
color: purple
